...
export function Home() {
  return <main>
    ...
    <section className='bg-blush/60'><div className='section-space page-shell'><div className='section-heading'><p className='eyebrow justify-center'>The Velvet Whisk promise</p><h2>Goodness in every little detail</h2></div><div className='grid gap-5 md:grid-cols-3'>

...
export function Navbar() {
  ...
  return <header className='sticky top-0 z-50 border-b border-[#eadfd8] bg-cream/95 backdrop-blur'>
    <div className='page-shell flex h-20 items-center justify-between'>
      <Link to='/' className='flex items-center text-cocoa' onClick={() => setOpen(false)}><img src='/images/kash-crumbs-logo.png' alt='Kash & Crumbs' className='h-[4.5rem] w-[4.5rem] object-contain' /><span className='sr-only'>Kash & Crumbs home</span></Link>
